...
// Config ...
var (
	PluginConfig = &gcscacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (gcscacheConfig) ConfigName() string {
	return "GCS"
}

// SetDefaults ...
func (a *gcscacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *gcscacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *gcscacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c gcscacheConfig) Wait() {
	<-c.done
}

// String ...
func (c gcscacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c gcscacheConfig) Debug() {
	// log.Debug("GCS PluginConfig = ", c)
}
