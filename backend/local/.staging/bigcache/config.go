...
type bigcachecacheConfig struct {
...
// Config ...
var (
	PluginConfig = &bigcachecacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (bigcachecacheConfig) ConfigName() string {
	return "BigCache"
}

// SetDefaults ...
func (a *bigcachecacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *bigcachecacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *bigcachecacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c bigcachecacheConfig) Wait() {
	<-c.done
}

// String ...
func (c bigcachecacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c bigcachecacheConfig) Debug() {
	// log.Debug("BigCache PluginConfig = ", c)
}
