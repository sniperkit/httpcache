...
type boltdbtreecacheConfig struct {
...
// Config ...
var (
	PluginConfig = &boltdbtreecacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (boltdbtreecacheConfig) ConfigName() string {
	return "BoltDB-TreeDB"
}

// SetDefaults ...
func (a *boltdbtreecacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *boltdbtreecacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *boltdbtreecacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c boltdbtreecacheConfig) Wait() {
	<-c.done
}

// String ...
func (c boltdbtreecacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c boltdbtreecacheConfig) Debug() {
	// log.Debug("BoltDB-TreeDB PluginConfig = ", c)
}
