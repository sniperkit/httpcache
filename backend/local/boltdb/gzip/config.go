...
type boltgzipcacheConfig struct {
...
// ConfigName ...
func (boltgzipcacheConfig) ConfigName() string {
	return "BoltGzip"
}

// SetDefaults ...
func (a *boltgzipcacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *boltgzipcacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *boltgzipcacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c boltgzipcacheConfig) Wait() {
	<-c.done
}

// String ...
func (c boltgzipcacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c boltgzipcacheConfig) Debug() {
	// log.Debug("BoltGzip PluginConfig = ", c)
}
