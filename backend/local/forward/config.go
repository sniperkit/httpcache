...
type forwardcacheConfig struct {
...
// Config ...
var (
	PluginConfig = &forwardcacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (forwardcacheConfig) ConfigName() string {
	return "Forward"
}

// SetDefaults ...
func (a *forwardcacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *forwardcacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *forwardcacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c forwardcacheConfig) Wait() {
	<-c.done
}

// String ...
func (c forwardcacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c forwardcacheConfig) Debug() {
	// log.Debug("Forward PluginConfig = ", c)
}
