...
type httpforcecacheConfig struct {
...
// ConfigName ...
func (httpforcecacheConfig) ConfigName() string {
	return "HttpForce"
}

// SetDefaults ...
func (a *httpforcecacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *httpforcecacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *httpforcecacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c httpforcecacheConfig) Wait() {
	<-c.done
}

// String ...
func (c httpforcecacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c httpforcecacheConfig) Debug() {
	// log.Debug("HttpForce PluginConfig = ", c)
}
