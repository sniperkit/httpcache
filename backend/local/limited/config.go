...
type limitedcacheConfig struct {
...
// ConfigName ...
func (limitedcacheConfig) ConfigName() string {
	return "Limited"
}

// SetDefaults ...
func (a *limitedcacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *limitedcacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *limitedcacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c limitedcacheConfig) Wait() {
	<-c.done
}

// String ...
func (c limitedcacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c limitedcacheConfig) Debug() {
	// log.Debug("Limited PluginConfig = ", c)
}
