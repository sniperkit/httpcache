...
// Config ...
var (
	PluginConfig = &libkvcacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (libkvcacheConfig) ConfigName() string {
	return "LibKV"
}

// SetDefaults ...
func (a *libkvcacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *libkvcacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *libkvcacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c libkvcacheConfig) Wait() {
	<-c.done
}

// String ...
func (c libkvcacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c libkvcacheConfig) Debug() {
	// log.Debug("LibKV PluginConfig = ", c)
}
