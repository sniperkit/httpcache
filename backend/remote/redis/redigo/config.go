...
// Config ...
var (
	PluginConfig = &redigocacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (redigocacheConfig) ConfigName() string {
	return "Redigo"
}

// SetDefaults ...
func (a *redigocacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *redigocacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *redigocacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c redigocacheConfig) Wait() {
	<-c.done
}

// String ...
func (c redigocacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c redigocacheConfig) Debug() {
	// log.Debug("Redigo PluginConfig = ", c)
}
