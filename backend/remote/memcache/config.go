...
// Config ...
var (
	PluginConfig = &memcacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (memcacheConfig) ConfigName() string {
	return "Memcache"
}

// SetDefaults ...
func (a *memcacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *memcacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *memcacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c memcacheConfig) Wait() {
	<-c.done
}

// String ...
func (c memcacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c memcacheConfig) Debug() {
	// log.Debug("Memcache PluginConfig = ", c)
}
