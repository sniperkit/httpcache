...
// Config ...
var (
	PluginConfig = &memcachedcacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (memcachedcacheConfig) ConfigName() string {
	return "Memcached"
}

// SetDefaults ...
func (a *memcachedcacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *memcachedcacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *memcachedcacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c memcachedcacheConfig) Wait() {
	<-c.done
}

// String ...
func (c memcachedcacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c memcachedcacheConfig) Debug() {
	// log.Debug("Memcached PluginConfig = ", c)
}
