...
// Config ...
var (
	PluginConfig = &etcd3cacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (etcd3cacheConfig) ConfigName() string {
	return "Etcd3"
}

// SetDefaults ...
func (a *etcd3cacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *etcd3cacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *etcd3cacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c etcd3cacheConfig) Wait() {
	<-c.done
}

// String ...
func (c etcd3cacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c etcd3cacheConfig) Debug() {
	// log.Debug("Etcd3 PluginConfig = ", c)
}
