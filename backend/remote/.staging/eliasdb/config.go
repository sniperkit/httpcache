...
type eliasdbcacheConfig struct {
...
// Config ...
var (
	PluginConfig = &eliasdbcacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (eliasdbcacheConfig) ConfigName() string {
	return "Tiedot"
}

// SetDefaults ...
func (a *eliasdbcacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *eliasdbcacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *eliasdbcacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c eliasdbcacheConfig) Wait() {
	<-c.done
}

// String ...
func (c eliasdbcacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c eliasdbcacheConfig) Debug() {
