...
type leveldbcacheConfig struct {
...
// Config ...
var (
	PluginConfig = &leveldbcacheConfig{
		done: make(chan struct{}),
	}
)

// ConfigName ...
func (leveldbcacheConfig) ConfigName() string {
	return "LevelDB"
}

// SetDefaults ...
func (a *leveldbcacheConfig) SetDefaults() {
	vipertags.SetDefaults(a)
}

// Read ...
func (a *leveldbcacheConfig) Read() {
	defer close(a.done)
	vipertags.Fill(a)
	if a.Provider == "" {
...
func (a *leveldbcacheConfig) Configor(files []string) {
	configor.Load(&PluginConfig, files...)
}

// Wait ...
func (c leveldbcacheConfig) Wait() {
	<-c.done
}

// String ...
func (c leveldbcacheConfig) String() string {
	return pp.Sprintln(c)
}

// Debug ...
func (c leveldbcacheConfig) Debug() {
	// log.Debug("LevelDB PluginConfig = ", c)
}
